...
Security Context Holder > Context > Authentication 에서
getPrincipal 우리가 전에 넣었던 정보( MuUserDetails )를 얻어와서 처리한다.
Authentication 이 해당 위치에 저장되어있어야만 스프링 시큐리티가 로그인으로 본다.
 */
@Component
